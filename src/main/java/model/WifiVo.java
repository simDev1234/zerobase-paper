...
public class WifiVo {
	...
	public WifiVo(Double distance, String x_SWIFI_MGR_NO, String x_SWIFI_WRDOFC, String x_SWIFI_MAIN_NM,
			...
			String x_SWIFI_INOUT_DOOR, String x_SWIFI_REMARS3, Double lAT, Double lNT, String wORK_DTTM) {
	...
	public WifiVo(String x_SWIFI_MGR_NO, String x_SWIFI_WRDOFC, String x_SWIFI_MAIN_NM,
			String x_SWIFI_ADRES1, String x_SWIFI_ADRES2, String x_SWIFI_INSTL_FLOOR, String x_SWIFI_INSTL_TY,
			String x_SWIFI_INSTL_MBY, String x_SWIFI_SVC_SE, String x_SWIFI_CMCWR, String x_SWIFI_CNSTC_YEAR,
			String x_SWIFI_INOUT_DOOR, String x_SWIFI_REMARS3, Double lAT, Double lNT, String wORK_DTTM) {
	...
	public Long getX_SWIFI_ID() {
		return X_SWIFI_ID;
	}

	public void setX_SWIFI_ID(Long x_SWIFI_ID) {
		X_SWIFI_ID = x_SWIFI_ID;
	}
